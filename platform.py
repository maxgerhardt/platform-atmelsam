...
class AtmelsamPlatform(PlatformBase):
    def configure_default_packages(self, variables, targets):
        ...
        if "arduino" in variables.get("pioframework", []):
            ...
            if build_core == "5gnbiot":
                self.packages["toolchain-gccarmnoneeabi"][
                    "version"] = ">=1.40803.0,<1.40805.0"
                self.packages["tool-bossac"]["version"] = "~1.10700.0"
                self.packages["framework-cmsis"]["version"] = "~1.40500.0"
                self.packages["framework-cmsis-atmel"]["version"] = "~1.1.0"
            if build_core == "canfduino":
                self.packages["toolchain-gccarmnoneeabi"]["version"] = "~1.90301.0"
                self.packages["tool-bossac"]["version"] = "~1.10700.0"
                self.packages["framework-cmsis"]["version"] = "~1.40500.0"
                self.packages["framework-cmsis-atmel"]["version"] = "https://github.com/maxgerhardt/framework-cmsis-atmel-canfduino.git"
